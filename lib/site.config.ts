...
export const site = {
  ...
  legalName: "AntCrow Limited",
  tagline: "A design & engineering studio building extraordinary websites.",
  description:
    "AntCrow is a web design and development studio serving New Zealand and Australia. We design and build brand identities, custom websites, and e-commerce for ambitious companies.",
