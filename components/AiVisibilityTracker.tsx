  ...
  return (
    <label className="block">
      ...
      <input
        ...
        className="mt-2 w-full rounded-xl border border-line bg-paper px-4 py-3 text-ink outline-none transition-colors placeholder:text-ash/60 focus:border-ink"
      />
    </label>
  );
}
